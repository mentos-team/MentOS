/// @file vga_graphics_palette.h
/// @brief 16-colour palette for the graphical VGA backend.
/// @copyright (c) 2014-2024 This file is distributed under the MIT License.
/// See LICENSE.md for details.
///
/// The standard IBM VGA 16-colour palette, in the order the console's attribute
/// nibbles index it. Components are given as 8-bit values for readability; the
...
static const vga_palette_entry_t vga_graphics_palette[16] = {
