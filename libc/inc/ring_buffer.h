...
#define DECLARE_DYNAMIC_SIZE_RING_BUFFER(type, name, init)                    \
    typedef struct {                                                          \
        ...
        unsigned count;                                                       \
                                                                              ...
                                                                              \
    static inline int rb_##name##_init(rb_##name##_t *rb, unsigned length,    \
    ...
    {                                                                         \
        ...
        return 0; /* Success */                                               \
                                                                              ...
                                                                              \
    static inline void rb_##name##_free(rb_##name##_t *rb,                    \
                                        void (*free_func)(void *))            \
    {                                                                         \
        if (rb->buffer) {                                                     \
            free_func(rb->buffer);                                            \
...
#define DECLARE_FIXED_SIZE_2D_RING_BUFFER(type, name, size1, size2, init,   \
    ...
    typedef struct {                                                        \
        ...
        unsigned size;                                                      \
                                                                            ...
                                                                            \
    void rb_##name##_entry_default_copy_fun(type *dest, const type *src,    \
                                            unsigned size)                  \
    {                                                                       \
    ...
    static inline unsigned rb_##name##_is_full(rb_##name##_t *rb)           \
    {                                                                       \
        return rb->count == size1;                                          \
    }                                                                       \
                                                                            \
    static inline void rb_##name##_push_back(rb_##name##_t *rb,             \
    ...
    {                                                                       \
        ...
        rb->head = (rb->head + 1) % size1;                                  \
                                                                            ...
                                                                            \
    static inline void rb_##name##_push_front(rb_##name##_t *rb,            \
                                              rb_##name##_entry_t *item)    \
    {                                                                       \
        if (rb_##name##_is_full(rb)) {                                      \
        ...
        rb->copy(rb->buffer[rb->tail].buffer, item->buffer, size2);         \
                                                                            ...
                                                                            \
    static inline int rb_##name##_pop_back(rb_##name##_t *rb,               \
                                           rb_##name##_entry_t *item)       \
    {                                                                       \
        if (rb_##name##_is_empty(rb)) {                                     \
            return 1;                                                       \
        ...
        return 0;                                                           \
                                                                            ...
                                                                            \
    static inline int rb_##name##_pop_front(rb_##name##_t *rb,              \
                                            rb_##name##_entry_t *item)      \
    {                                                                       \
        if (rb_##name##_is_empty(rb)) {                                     \
            return 1;                                                       \
        ...
        return 0;                                                           \
                                                                            ...
                                                                            \
    static inline int rb_##name##_peek_back(rb_##name##_t *rb,              \
                                            rb_##name##_entry_t *item)      \
    {                                                                       \
        if (rb_##name##_is_empty(rb)) {                                     \
            return 1;                                                       \
        ...
        return 0;                                                           \
                                                                            ...
                                                                            \
    static inline int rb_##name##_peek_front(rb_##name##_t *rb,             \
                                             rb_##name##_entry_t *item)     \
    {                                                                       \
        if (rb_##name##_is_empty(rb)) {                                     \
            return 1;                                                       \
        ...
        return 0;                                                           \
                                                                            ...
                                                                            \
    static inline int rb_##name##_get(rb_##name##_t *rb, unsigned position, \
                                      rb_##name##_entry_t *item)            \
    {                                                                       \
